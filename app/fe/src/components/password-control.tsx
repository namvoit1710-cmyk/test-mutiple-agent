      ...
      >
        {showPassword ? (
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-4.5 0-8.22-3.14-8.8-7.94l1.2-1.2C4.45 10.5 5.5 10 6.6 10c1.1 0 2.1.5 2.8 1.4l1.2 1.2c.58 4.8 4.3 7.94 8.8 7.94z" />
